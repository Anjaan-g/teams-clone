            ...
            <div className="flex flex-col">
                <div className="flex justify-between items-center h-full">
                    ...
                    <div className="flex items-center gap-3 justify-end">
                        <div className="h-8 w-8 rounded-full bg-day flex items-center justify-center cursor-pointer">
                            <BsFilter size={20} />
                        </div>
                        ...
                        <div className="h-8 w-8 rounded-full bg-blue-200 flex items-center justify-center cursor-pointer">
                            <FiEdit size={20} />
                        </div>
                    </div>
                </div>
